<template>
  <div class="q-pa-md q-gutter-sm row">
    ...
    <div class="q-pa-md q-gutter-sm" style="width: 800px">
      <q-table title="Actions" :columns="columns" :rows="actions" row-key="action_id" selection="single"
        v-model:selected="selectedAction">
      </q-table>
      <!-- functionality of ADD Button -->
      <q-btn icon="o_file_open" color="primary" label="Add" @click="addprompt = true" />
        ...
        <q-card style="min-width: 1200px">
          ...
          <q-card-actions
            ...
            <q-btn
              ...
              type="submit"
              @click="addAction(aname, astore.getparameter()[0]); initForm()"
              v-close-popup />
