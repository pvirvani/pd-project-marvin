<template>
  ...
  >
    <p style="font-size: 20px; text-align:center;"><b> Project: {{parent_name}}</b></p>
  </div>
  <br />
  <br />
      ...
      <q-card style="min-width: 350px">
        ...
        <q-card-actions align="right" class="text-primary">
          ...
          <q-btn
            ...
            v-close-popup
            type="submit"
            @click="addDemo(parent_id,parent_name,d_name);initForm()"
          />
      ...
      <q-card style="min-width: 350px">
        ...
        <q-card-actions align="right" class="text-primary">
          ...
          <q-btn
            ...
            v-close-popup
            type="submit"
            @click="editDemo(parent_id,parent_name,selectedDemo[0].demo_id,d_name);initForm()"
          />
      ...
      <q-card style="min-width: 350px">
        ...
        >
          ...
          <q-btn
            ...
            v-close-popup
            type="submit"
            @click="deleteDemo(parent_id, parent_name,selectedDemo[0].demo_id)"
          />
        </q-card-actions>
      </q-card>
    </q-dialog>
