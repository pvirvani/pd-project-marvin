const routes = [
  ...
  // },
  {
    ...
    component: () => import("layouts/MainLayout.vue"),
    children: [
      { path: "", component: () => import("pages/NewHomePage.vue") },
    ],
  },
  // {
  //   path: "/nhome",
  ...
  // },
  {
    ...
    component: () => import("layouts/MainLayout.vue"),
    children: [
      { path: ":id", name: "demo", props: true, component: () => import("pages/OnDemonstration.vue") },
    ],
  },
  {
    path: "/problems/",
  ...
  },
  {
    path: "/roscon",
    component: () => import("layouts/MainLayout.vue"),
    children: [{ path: "", component: () => import("src/pages/RosConnection.vue") }],
  },
  {
    path: "/stest",
    component: () => import("layouts/MainLayout.vue"),
