    ...
    <div class="q-pa-md">
        <q-table title="Available Projects"
            ...
            <!--             <q-tr v-for="(tdata, i) in table_data"
                  :key="i">
                <q-td>{{ tdata.names[i] }}</q-td>
                <q-td>{{ tdata.actions[i] }}</q-td>
                <q-td>{{ tdata.problems[i] }}</q-td>
            </q-tr> -->
            <!-- <template v-slot:body-cell="props"> -->
            <q-tr :id="props.row.name"
                  :props="props">
                <q-td key="name"
                      :props="props">{{ props.row.names }}</q-td>
                <q-td :key="actions"
                      :props="props">{{ props.row.actions }}</q-td>
                <q-td :key="problems"
                      :props="props">{{ props.row.problems }}</q-td>
        ...
        <!--  <table>
            ...
            <tr v-for="(tdata, i) in table_data"
                :key="i">
                <td> {{ tdata.names[i] }} </td>
                <td> {{ tdata.problems[i] }}</td>
                <td> {{ tdata.actions[i] }} </td>
            </tr>
        </table> -->
